...
**Status:** `Technical alpha` (M0 shipped; first real baseline 2026-07-13: **152 sources, 52 of 52 jurisdictions**, zero false drift on a second consecutive pass) · **Track:** Civic / trans infrastructure · **License:** [AGPL-3.0-or-later](./LICENSE) · **Runtime deps:** zero (stdlib only)
