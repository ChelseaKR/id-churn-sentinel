...
This is the proposed V1 operational model, not a live service-level
commitment; no operating service exists yet.
...
- correction/withdrawal and consumer notification;
